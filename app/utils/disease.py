...
disease_dic = {
    'Apple___Apple_scab': _(""" <b>Crop</b>: Apple <br/>Disease: Apple Scab<br/>
        <br/> Cause of disease:
    ...
    'Apple___Black_rot': _(""" <b>Crop</b>: Apple <br/>Disease: Black Rot<br/>
        <br/> Cause of disease:
    ...
    'Apple___Cedar_apple_rust': _(""" <b>Crop</b>: Apple <br/>Disease: Cedar Apple Rust<br/>
        <br/> Cause of disease:
    ...
    'Apple___healthy': _(""" <b>Crop</b>: Apple <br/>Disease: No disease<br/>
    ...
    'Blueberry___healthy': _(""" <b>Crop</b>: Blueberry <br/>Disease: No disease<br/>
    ...
    'Cherry_(including_sour)___Powdery_mildew': _(""" <b>Crop</b>: Cherry <br/>Disease: Powdery Mildew<br/>
        <br/> Cause of disease:
    ...
    'Cherry_(including_sour)___healthy': _(""" <b>Crop</b>: Cherry <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!"""),

    'Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot': _(""" <b>Crop</b>: Corn <br/>Disease: Grey Leaf Spot<br/>
        <br/> Cause of disease:
    ...
    'Corn_(maize)___Common_rust_': _(""" <b>Crop</b>: Corn(maize) <br/>Disease: Common Rust<br/>
        <br/> Cause of disease:
    ...
    'Corn_(maize)___Northern_Leaf_Blight': _(""" <b>Crop</b>: Corn(maize) <br/>Disease: Northern Leaf Blight
        <br/>
        <br/> Cause of disease:
    ...
    'Grape___Black_rot': _(""" <b>Crop</b>: Grape <br/>Disease: Black Rot<br/>
        <br/> Cause of disease:
    ...
    'Corn_(maize)___healthy': _(""" <b>Crop</b>: Corn(maize) <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!"""),


    'Grape___Esca_(Black_Measles)': _(""" <b>Crop</b>: Grape <br/>Disease: Black Measles<br/>
        <br/> Cause of disease:
    ...
    'Grape___Leaf_blight_(Isariopsis_Leaf_Spot)': _(""" <b>Crop</b>: Grape <br/>Disease: Leaf Blight<br/>
        <br/> Cause of disease:
    ...
    'Grape___healthy': _(""" <b>Crop</b>: Grape <br/>Disease: No disease<br/>
    ...
    'Grape___Leaf_blight_(Isariopsis_Leaf_Spot)': _("""<b> Crop</b> : Grape <br/> Disease: Leaf Spot"""),


    'Orange___Haunglongbing_(Citrus_greening)': _(""" <b>Crop</b>: Orange <br/>Disease: Citrus Greening<br/>
        <br/> Cause of disease:
    ...
    'Peach___Bacterial_spot': _(""" <b>Crop</b>: Peach <br/>Disease: Bacterial Spot<br/>
        <br/> Cause of disease:
    ...
    'Pepper,_bell___Bacterial_spot': (
        _(" <b>Crop</b>: Pepper <br/>Disease: Bacterial Spot<br/>") +
        "<br/> " + _(" Cause of disease:") +
        "<br/><br/> 1. " + _("Bacterial spot is caused by several species of gram-negative bacteria in the genus Xanthomonas.") +
        "<br/><br/> 2. " + _("In culture, these bacteria produce yellow, mucoid colonies. A mass of bacteria can be observed oozing from a lesion by making a cross-sectional cut through a leaf lesion, placing the tissue in a droplet of water, placing a cover-slip over the sample, and examining it with a microscope (approximately 200X).") +
        "<br/><br/> " + _(" How to prevent/cure the disease ") + "<br/>" +
        "<br/>1. " + _("The primary management strategy of bacterial spot begins with use of certified pathogen-free seed and disease-free transplants.") +
        "<br/><br/>2. " + _("The bacteria do not survive well once host material has decayed, so crop rotation is recommended. Once the bacteria are introduced into a field or greenhouse, the disease is very difficult to control.") +
        "<br/><br/>3. " + _("Pepper plants are routinely sprayed with copper-containing bactericides to maintain a protective cover on the foliage and fruit.")
    ),

    'Peach___healthy': _(""" <b>Crop</b>: Peach <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!"""),

    'Pepper,_bell___healthy': _(""" <b>Crop</b>: Pepper <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!"""),


    'Potato___healthy': _(""" <b>Crop</b>: Potato <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!"""),

    'Raspberry___healthy': _(""" <b>Crop</b>: Raspberry <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!"""),


    'Soybean___healthy': _(""" <b>Crop</b>: Soyabean <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!"""),

    'Strawberry___healthy': _(""" <b>Crop</b>: Strawberry <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!"""),

    'Tomato___healthy': _(""" <b>Crop</b>: Tomato <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!"""),


    'Potato___Early_blight': _(""" <b>Crop</b>: Potato <br/>Disease: Early Blight<br/>
        <br/> Cause of disease:
    ...
    'Potato___Late_blight': _(""" <b>Crop</b>: Potato <br/>Disease: Late Blight<br/>
    ...
    'Squash___Powdery_mildew': _(""" <b>Crop</b>: Squash <br/>Disease: Powdery mildew<br/>
        <br/> Cause of disease:
    ...
    'Strawberry___Leaf_scorch': _(""" <b>Crop</b>: Strawberry <br/>Disease: Leaf Scorch<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Bacterial_spot': _(""" <b>Crop</b>: Tomato <br/>Disease: Bacterial Spot<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Late_blight': _(""" <b>Crop</b>: Tomato <br/>Disease: Late Blight<br/>
    ...
    'Tomato___Leaf_Mold': _(""" <b>Crop</b>: Tomato <br/>Disease: Leaf Mold<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Septoria_leaf_spot': _(""" <b>Crop</b>: Tomato <br/>Disease: Leaf Spot<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Spider_mites Two-spotted_spider_mite': _(""" <b>Crop</b>: Tomato <br/>Disease: Two-spotted spider mite<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Target_Spo': _(""" <b>Crop</b>: Tomato <br/>Disease: Target Spot<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Tomato_Yellow_Leaf_Curl_Virus': _(""" <b>Crop</b>: Tomato <br/>Disease: Yellow Leaf Curl Virus<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Tomato_mosaic_virus': _(""" <b>Crop</b>: Tomato <br/>Disease: Mosaic Virus<br/>
        <br/> Cause of disease:
